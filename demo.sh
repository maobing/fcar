...
./extractFeature -i ../coveragesFile_DNaseFlash  -t ../CTCFData_narrowPeak_Ag09319_genomewide.txt -o ../CTCFOutputFeature_Gm12878_genomewide.txt -p ../param_DNaseHistone
